...
You can make something like this in your translation file:
...
And all models that have a title will be translated like that, except if you defined a more specific translation like above for that model.
